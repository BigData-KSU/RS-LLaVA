...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            #### This for CD dataset...................
            ####################################################################
            if 'im1' in image_file:
                image_file = image_file.replace('im1', 'im2')
                # print(image_file)
                image2 = Image.open(os.path.join(image_folder, image_file)).convert('RGB')
                image = ImageChops.difference(image, image2)
...
def train():
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            print('Get model here....')
            print(model_args.model_name_or_path)
            model = LlavaLlamaForCausalLM.from_pretrained(
                #model_args.model_name_or_path,
               # 'meta-llama/Llama-2-7b-chat-hf',
                "./checkpoints/v1.5-7b",
              #  "./checkpoints/ShareGPT4V-7B",
    ...
    if model_args.vision_tower is not None:
        ...
        if model_args.tune_mm_mlp_adapter:
            ...
            print('I will Tune the projectors................')
            #exit(0)
    ...
    """
    if checkpoint_dirs:
        # Sort the directories to get the latest checkpoint
...
if __name__ == "__main__":
    ...
    execution_time = (end_time - start_time)/3600  # Execution time in seconds
